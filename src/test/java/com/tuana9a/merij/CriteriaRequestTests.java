...
public class CriteriaRequestTests {
    @Test
    public void testIs() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
    ...
    @Test
    public void testNe() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
        Criteria criteria = CriteriaRequest.resolve("name!=tuana9a").toCriteria();
        Assertions.assertEquals(criteria, Criteria.where("name").ne("tuana9a"));
    }

    @Test
    public void testGt() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
        Criteria criteria = CriteriaRequest.resolve("age>10").toCriteria();
        Assertions.assertEquals(criteria, Criteria.where("age").gt(10));
    }

    @Test
    public void testLt() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
        Criteria criteria = CriteriaRequest.resolve("age<10").toCriteria();
        Assertions.assertEquals(criteria, Criteria.where("age").lt(10));
    }

    @Test
    public void testGte() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
        Criteria criteria = CriteriaRequest.resolve("age>=10").toCriteria();
        Assertions.assertEquals(criteria, Criteria.where("age").gte(10));
    }

    @Test
    public void testLte() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
        Criteria criteria = CriteriaRequest.resolve("age<=10").toCriteria();
        Assertions.assertEquals(criteria, Criteria.where("age").lte(10));
    }

    @Test
    public void testIn() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
    ...
    @Test
    public void testEqNull() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
    ...
    @Test
    public void testEqUndefined() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
        Criteria criteria = CriteriaRequest.resolve("name==undefined").toCriteria();
        Assertions.assertEquals(criteria, Criteria.where("name").is(null));
    }

    @Test
    public void testLtGt() throws CriteriaQueryLogicException, CriteriaOperationNotSupported, QueryPatternNotMatchException {
